...
int heuristic(OthelloBoard now)
{
    ...
    for(int i=0;i<8;i++)
    {
        for(int j=0;j<8;j++)
        {
            ...
            if(now.board[0][0] == 0)
            {
                if((now.board[0][1] == player)&&(now.board[0][2] == 3-player)) heu -= 50;
                if((now.board[1][0] == player)&&(now.board[2][0] == 3-player)) heu -= 50;
                if((now.board[1][1] == player)&&(now.board[2][2] == 3-player)) heu -= 50;
            }
            if(now.board[0][7] == 0)
            {
                if((now.board[0][6] == player)&&(now.board[0][5] == 3-player)) heu -= 50;
                if((now.board[1][7] == player)&&(now.board[2][7] == 3-player)) heu -= 50;
                if((now.board[1][6] == player)&&(now.board[2][5] == 3-player)) heu -= 50;
            }
            if(now.board[7][0] == 0)
            {
                if((now.board[7][1] == player)&&(now.board[7][2] == 3-player)) heu -= 50;
                if((now.board[6][0] == player)&&(now.board[5][0] == 3-player)) heu -= 50;
                if((now.board[6][1] == player)&&(now.board[5][2] == 3-player)) heu -= 50;
            }
            if(now.board[7][7] == 0)
            {
                if((now.board[7][6] == player)&&(now.board[7][5] == 3-player)) heu -= 50;
                if((now.board[6][7] == player)&&(now.board[5][7] == 3-player)) heu -= 50;
                if((now.board[6][6] == player)&&(now.board[5][5] == 3-player)) heu -= 50;
            }
...
void write_valid_spot(std::ofstream& fout) {
    ...
    for(int d=0;d<n_valid_spots;d++)
    {
        ...
        if(board_new.disc_count[0] <= 11)
            ...
            value_cur = minmax(board_new, 4, 3-player, A, B);
